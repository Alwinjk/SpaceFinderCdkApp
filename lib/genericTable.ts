...
export class GenericTable {
    ...
    private stack: Stack; // this generic table must be included in a stack, thereby I am adding a stack here
    private table: Table;
    ...
    private createSingleLambda(lambdaName: string): NodejsFunction {
        ...
        return new NodejsFunction(this.stack, lambdaId, {
            entry: (join(__dirname, '..', 'services', this.props.tableName, `${lambdaName}.js`)),
            handler: 'handler',
